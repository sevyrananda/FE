...
export const Container = styled.div`
  ...
  max-width: 100%;
  min-height: 400px;
  margin: 0 auto; /* Menengahkan elemen horizontalmente */
  display: flex;
...
background: #ff416c;
background: -webkit-linear-gradient(to right, #2A84B7, #2A84B7);
background: linear-gradient(to right, #2A84B7, #2A84B7);
